...
apiUsuarios=Blueprint('apiUsuarios',__name__)

###################################################################################
#                DATOS DE USUARIOS
###################################################################################

@apiUsuarios.route('/getAll', methods=['post'],strict_slashes=False)
def getAll():
...
@apiUsuarios.route('/new', methods=['post'],strict_slashes=False)
def new():
...
@apiUsuarios.route('/update', methods=['post'],strict_slashes=False)
def update():
...
@apiUsuarios.route('/delete', methods=['post'],strict_slashes=False)
def delete():
